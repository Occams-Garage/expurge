...
- The mobile-specific `.eml`-fallback guardrail (fall back off `.eml` on mobile) is NOT built in v1: mobile doesn't exist in v1. Recorded as a phantom-requirement cleanup to prevent premature build.
