...
- Refresh the header status span in place: `refreshBrokerGroupHeader()` updates only that span after mark-as-sent, avoiding a full re-render that would close open panels.
