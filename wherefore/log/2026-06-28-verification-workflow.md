...
## Decisions / outcomes
- 8-item checklist (identical for maintainer and every contributor): opt-out target, kind, method-really-works, required subject, requester requirements, ID requirements, search sanity check, receipt. Channel verified only when items 1 to 6 and 8 hold.
