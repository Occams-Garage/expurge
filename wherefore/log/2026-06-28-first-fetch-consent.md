...
- Shows a single quiet line in the Run done state when auto-update is disabled and the broker list is more than 30 days old: "Broker list is N days old. Enable auto-updates in Settings →" or "Update manually in Settings →."
