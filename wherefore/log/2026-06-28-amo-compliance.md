...
## Decisions / outcomes
**Four standing build constraints (apply to every milestone):**
...
3. **Overlay**: must never inject the user's profile data into the page DOM. Overlay UI must be entirely self-contained.
